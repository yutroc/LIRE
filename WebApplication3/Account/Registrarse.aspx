<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Registrarse.aspx.vb" Inherits="WebApplication3.Registrarse" %>
...
<p>
    <asp:FormView ID="FormViewCrearUser" runat="server" DataKeyNames="username" 
        DataSourceID="SqlDataSourceUsuario" style="margin-top: 21px">
        <EditItemTemplate>
            username:
            ...
            <br />
            fecha_registro:
            <asp:TextBox ID="fecha_registroTextBox" runat="server" 
                Text='<%# Bind("fecha_registro") %>' />
            <br />
        ...
        <InsertItemTemplate>
            ...
            <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" 
                SelectedValue='<%# Bind("id_rol") %>' Visible="False">
                <asp:ListItem>1</asp:ListItem>
            </asp:DropDownList>
            <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" 
                SelectedValue='<%# Bind("icon_url") %>' Visible="False">
                <asp:ListItem>icon</asp:ListItem>
            </asp:DropDownList>
            <asp:DropDownList ID="DropDownList3" runat="server" AutoPostBack="True" 
                SelectedValue='<%# Bind("biografia") %>' Visible="False">
                <asp:ListItem>biografia</asp:ListItem>
            </asp:DropDownList>
            <asp:DropDownList ID="DropDownList4" runat="server" AutoPostBack="True" 
                SelectedValue='<%# Bind("fecha_registro") %>' Visible="False">
...
&nbsp;&nbsp;
        ...
        <ItemTemplate>
            ...
            <br />
            fecha_registro:
            <asp:Label ID="fecha_registroLabel" runat="server" 
                Text='<%# Bind("fecha_registro") %>' />
            <br />
    ...
    <asp:SqlDataSource ID="SqlDataSourceUsuario" runat="server" 
        ...
        InsertCommand="INSERT INTO [Usuario] ([username], [password], [id_rol], [icon_url], [email], [biografia], [fecha_registro]) VALUES (@username, @password, @id_rol, @icon_url, @email, @biografia, @fecha_registro)" 
        ...
        <SelectParameters>
            <asp:SessionParameter DbType="Date" Name="fecha_registro" 
                SessionField="fechaActual" />
            <asp:SessionParameter Name="icon_url" SessionField="iconoDefault" 
                Type="String" />
            <asp:SessionParameter Name="biografia" SessionField="biografiaDefault" 
                Type="String" />
            <asp:SessionParameter Name="id_rol" SessionField="idRolDefault" 
                Type="Decimal" />
        </SelectParameters>
        <UpdateParameters>
            <asp:Parameter Name="password" Type="String" />
